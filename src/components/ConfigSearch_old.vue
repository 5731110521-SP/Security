<template>
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            <div class="container">
                <div class="row" style="align-items: center;">
                    <div class="col">
                        <button class="submitBtn" style="width:200px" type="button" @click="showAddModal">Add Configuration Key</button>
                    </div>
                    <a>Search By:</a>
                    <multiselect
                    ...
                    <input type="text" value="" v-model="searchValue">
                    <!-- <div class="col">
                        <button class="submitBtn" type="submit">Search</button>
                        <button class="submitBtn" type="button" @click="clear">Clear</button>
                    </div> -->
                </div>
            </div>
        </form>
        <div style="margin-top:30px">
            ...
            <!-- <b-table responsive :items="paginatedData"></b-table> -->
